...
GLOBAL_UNITS = [
    ...
    ("voc.cpp", "VocClass", ["Fill_In"],
     {"file": "sound01.ini", "group": "Sounds",
      "section_vars": {"Name": section_selectors.identifier("sound"),
                       "Name()": section_selectors.identifier("sound"),
                       "IniName": section_selectors.identifier("sound")}}),
