...
The same read also fills a second figure named `EngineerDamage`, which nothing consults; [settings without effect](/systems/capture/#settings-without-effect) covers why writing that name does nothing.
