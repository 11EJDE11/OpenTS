...
The list is read as BuildingType IDs without regard to case, and a name matching none is dropped. An empty list leaves `NODFACTORY` impossible to satisfy, which blocks every type naming it.
