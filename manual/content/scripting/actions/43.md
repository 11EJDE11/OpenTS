...
The piece is created at the waypoint's ground height, raised by the bridge height where a bridge covers or has covered the cell. What happens next is entirely a property of the type dropped: a debris type set to [fly in as a meteor](/keys/ismeteor/#scope-voxelanimtype) is placed back along its approach and comes down onto the waypoint, and one that is not simply appears there and is thrown about by the ordinary debris physics.
