...
:::danger[A country no house is playing faults the action]
The country the action names is looked up among the houses the scenario plays, and the result is used without being checked. In a campaign or a standalone mission the first direction passes over the missing house without touching it and the second faults as it reaches that house's anger record; anywhere else the first direction faults at once, on the passive test.
:::
