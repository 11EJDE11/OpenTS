...
Each object that clears them changes hands through the ordinary capture path — the same one [an engineer walking into a structure](/systems/capture/) runs — with the selected house as the new owner.
