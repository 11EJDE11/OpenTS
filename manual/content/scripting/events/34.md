...
An object carrying this trigger reports the proximity event during its normal update. The event resolves the chosen waypoint to a coordinate and succeeds when the object's distance to it is no more than five cell widths.
