---
type: event
id: TEVENT_BUILD_AIRCRAFT
title: Build Aircraft Type...
summary: Satisfied while the named aircraft is the last one the trigger's own house finished producing.
valid_values:
