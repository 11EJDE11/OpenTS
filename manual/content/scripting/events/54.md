...
summary: Fires while a sweeping beam on the tagged structure has a non-allied soldier or vehicle inside its detection radius, and refuses to be marked off once it has.
caveats:
