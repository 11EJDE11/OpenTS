...
;****************************************************************************
	...
	PUBLIC	sosCODECInitStream
	sosCODECInitStream PROC NEAR \
	\
	sSOSInfo:DWORD
...
;****************************************************************************
	...
	PUBLIC	sosCODECDecompressData
	sosCODECDecompressData PROC NEAR \
	\
	sSOSInfo:DWORD, \
	wBytes:DWORD
	...
	mov	cx,[[ebx].wBitSize] ;check the bit size
	mov	dx,[[ebx].wChannels] ;check the number of channels
;
;
...
??decomp16Mono:
	...
	mov	esi,[[ebx].lpSource]	;get source address
	mov	edi,[[ebx].lpDest]	;get dest address
