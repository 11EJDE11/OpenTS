...
Clip_Rect PROC near \
	...
	sub	esi,[_width]	; get the difference (x0 - (width + 1))
	sub	eax,[_width]	; get the difference (x1 - (width + 1))
	dec	esi
	dec	eax
...
bottom_ok:
	...
	mov	ebx,[_width]	; ebx = the width of the window
