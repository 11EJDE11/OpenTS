...
const IID LIBID_TiberianSun = {0xB45A4A80,0x86DA,0x11D1,{0xB7,0x06,0x00,0xA0,0x24,0xDD,0xAF,0xD1}};


const CLSID CLSID_TiberianSun = {0xB45A4A81,0x86DA,0x11D1,{0xB7,0x06,0x00,0xA0,0x24,0xDD,0xAF,0xD1}};
...
const IID LIBID_AIHouseClass = {0xE97EC0D0,0x86DA,0x11D1,{0xB7,0x06,0x00,0xA0,0x24,0xDD,0xAF,0xD1}};


const CLSID CLSID_AIHouse = {0xF706E6E0,0x86DA,0x11D1,{0xB7,0x06,0x00,0xA0,0x24,0xDD,0xAF,0xD1}};


const CLSID CLSID_AIMeade = {0x9E0F6120,0x87C1,0x11D1,{0xB7,0x07,0x00,0xA0,0x24,0xDD,0xAF,0xD1}};


const CLSID CLSID_AIJackson = {0xC6004D80,0x87D1,0x11D1,{0xB7,0x07,0x00,0xA0,0x24,0xDD,0xAF,0xD1}};


const CLSID CLSID_AIGrant = {0xFBE6D4A0,0x87D1,0x11D1,{0xB7,0x07,0x00,0xA0,0x24,0xDD,0xAF,0xD1}};


const CLSID CLSID_AIHooker = {0xFBE6D4A1,0x87D1,0x11D1,{0xB7,0x07,0x00,0xA0,0x24,0xDD,0xAF,0xD1}};
